...
stock_df1 = pd.read_csv('/data1/zhouwanyun/data/stock_data/industry_sp500.csv')
stock_list = stock_df1['Symbol'].tolist()
stock_list.remove('FRC')



stock_sector = pd.read_csv(r'/data1/zhouwanyun/data/stock_data/industry_sp500_new.csv', encoding='latin1')[['Symbol', 'INDUSTRY_GICS']]
...
# df_valid = pd.read_csv('/data1/zhouwanyun/quantbench/src/mlruns/717233524665939863/6dfcfcf077da4c3eb507389027e8919e/artifacts/outputs/valid_pred_ic.csv', index_col=0)
# valid_label = pd.read_csv('/data1/zhouwanyun/quantbench/src/mlruns/717233524665939863/6dfcfcf077da4c3eb507389027e8919e/artifacts/outputs/valid_label.csv', index_col=0)

df_valid1 = pd.read_csv('/data1/zhouwanyun/mlruns/385851665399949056/4e34999712ae443491da0992a9d72d23/artifacts/outputs/valid_pred_ic.csv', index_col=0)
valid_label1 = pd.read_csv('/data1/zhouwanyun/mlruns/385851665399949056/4e34999712ae443491da0992a9d72d23/artifacts/outputs/valid_label.csv', index_col=0)
df_valid2 = pd.read_csv('/data1/zhouwanyun/mlruns/385851665399949056/4e34999712ae443491da0992a9d72d23/artifacts/outputs/pred.csv', index_col=0)
valid_label2 = pd.read_csv('/data1/zhouwanyun/mlruns/385851665399949056/4e34999712ae443491da0992a9d72d23/artifacts/outputs/label.csv', index_col=0)
...
file_stock = '/data1/zhouwanyun/data/stock_data/psudo_sp500.csv'
...
stock_price_df = pd.read_csv('/data1/zhouwanyun/data/stock_data/main/us/features/day/close.csv')
...
csv_file_path = '/data1/zhouwanyun/merged_df_with_calculated_sp500.csv'
...
#     # 筛选出当日 `calculated_avg` 不为 NaN 且不为 0 的股票
...
#                 # 获取前10个或绝对值小于-0.75的，优先级为绝对值小于-0.8
...
# # 使用 pickle 将所有的图结构矩阵字典存储为二进制文件，以便快速加载
...
def get_daily_graph_data(day):
    ...
    x = df_merge_day[['psudo_label', 'calculated_avg']].values
    # x = df_merge_day[['valid_value', 'psudo_label', 'calculated_avg']].values

    #如果x出现了nan值， 就print出来x
    # if x.isnull().any():
    #     print(x)
...
# optimizer = torch.optim.Adam(model.parameters(), lr=0.001813187455535416)
...
split_index_21 = int(proportion_2021_before * len(x_list)) +2
split_index_22 = int(proportion_2022_before * len(x_list)) +3
...
def train(epoch):
    ...
    for x, y, industry_edge_index, pos_corr_edge_index, acc_base, acc_mod in train_data:
        ...
        condition = x[:, -1] != 0
        # 替换的值: 如果 condition 为 True，保留 x[:, 2]，否则用 out.squeeze()
...
for epoch in range(50):
    ...
    if (epoch >= 0) and (epoch % 5) == 0:
        ...
        if valid_ic >= valid_ic_best:
            ...
            torch.save(model.state_dict(), 'best_model_sp500_tmpgcn.pth')
        print(f'Validation Epoch {epoch}, Loss: {loss:.4f}, Accuracy1: {accuracy:.4f}')
        print('ACC 2: ', acc_base)
        print('ACC 3: ', acc_mod)
        print('Output metrics: ', valid_metric_out)
        print('Origin metrics: ', valid_metric_origin)
        print('Zero metrics: ', valid_metric_zero)

model.load_state_dict(torch.load('best_model_sp500_tmpgcn.pth'))
model.eval()  # 设置模型为评估模式
print("Model loaded")
accuracy, acc_base, acc_mod, valid_metric_out, valid_metric_origin,valid_metric_zero = evaluate(valid_data=test_data,valid_idx=test_idx,quantile= 0.1)
