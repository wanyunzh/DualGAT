...
stock_df1 = pd.read_csv('/data1/zhouwanyun/data/stock_data/stocktable_new.csv')
stock_list = stock_df1['Symbol'].tolist()



stock_sector = pd.read_csv(r'/data1/zhouwanyun/data/stock_data/stocktable_new.csv', encoding='latin1')[['Symbol', 'Sector']]
...
file_stock = '/data1/zhouwanyun/data/stock_data/psudo_stocktable.csv'
...
csv_file_path = '/data1/zhouwanyun/merged_df_with_calculated_stocknet_new.csv'
